...
<head>
    ...
    <link rel="stylesheet" href="css/metodopagoadmin.css">
        ...
        <div class="container">
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group1">
                            <select class="select-options" id="txt_metodopago" required>
                        ...
                        <div class="form-group">
                            <input type="text" class="entrada_texto" id="txt_entidadfinanciera" required>
                            <label class="label-input">Entidad Financiera</label>
                        </div>
                        <div class="form-group">
                            <input type="text" class="entrada_texto" id="txt_moneda" required>
                            <label class="label-input">Moneda</label>
                        </div>

                    </div>
                    <button type="button" class="btn_crear_producto" id="btn_crearpago">
            ...
            <div class="section">
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group">
                            <input type="number" class="entrada_texto" name="id" id = "txt_idbuscar" min="1" placeholder="0" required>
                            <label class="label-input-number">ID del medoto de pago a buscar</label>
                        </div>
                    </div>
                    <button type="button" class="btn_buscar" id="btn_buscarpago">
            ...
            <div class="section">
                ...
                <form class="ingresar_id_act_producto">
                    <div class="form-group">
                        <input type="number" class="entrada_texto" name="id" id="txt_ideditar" min="1" placeholder="0" required>
                ...
                <form class="form_datos_actualizar_producto">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <input type="text" class="entrada_texto" id="txt_metodopago" required>
                        ...
                        <div class="form-group">
                            <input type="number" class="entrada_texto" name="precio" id="txt_moneda" step="0.01" min="0"
                                placeholder="0.00" required>
                            <label class="label-input-number">Moneda</label>
                        </div>

                    </div>
                    <button type="button" class="btn_editar" id="btn_actualizar">
            ...
            <div class="section">
                ...
                <form>
                    <div class="form-group">
                        <input type="number" class="entrada_texto" name="id" id="txt_ideliminar" min="1" placeholder="0" required>
                        <label class="label-input-number">ID del metodo de pago a eliminar:</label>
                    </div>
                </form>
                <form class="form_btn_eliminar_buscar">
                    <button type="button" class="btn_buscar" id="txt_idbuscar">
                    ...
                    <button type="button" class="btn_eliminar" id="txt_ideliminar">
